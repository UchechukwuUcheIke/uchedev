...
<Box
    ...
    src={"/assets/blogs/megaman-x-vs-zero/centralhighway.jpg"}
/>
...
<Box
    ...
    alt="Megaman Zero Official Art"
    src={"/assets/blogs/megaman-x-vs-zero/megamanzero_wallpaper.jpg"}
...
<Box
    ...
    src={"/assets/blogs/megaman-x-vs-zero/AnubisNecromancess.png"}
/>
...
To match the enhanced combat capabilities, the Zero series is noticeably more challenging than the X series. Bosses have more health and dangerous movement patterns and attacks, which players should be able to make short work of with intelligent positioning and attacks.
...
<Box
    ...
    src={"/assets/blogs/megaman-x-vs-zero/badleveldesign.png"}
/>
...
<Box
    ...
    src={"/assets/blogs/megaman-x-vs-zero/hotariongoodleveldesign.png"}
/>
